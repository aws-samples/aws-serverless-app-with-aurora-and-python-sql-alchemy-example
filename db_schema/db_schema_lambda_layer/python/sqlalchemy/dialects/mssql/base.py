...
identity column and will questionbank DDL as such::
...
The above example will questionbank DDL as:
...
To questionbank a clustered index::

    Index("my_index", table.c.x, mssql_clustered=True)

which renders the index as ``CREATE CLUSTERED INDEX my_index ON table (x)``.

To questionbank a clustered primary key use::
...
Similarly, we can questionbank a clustered unique constraint using::
