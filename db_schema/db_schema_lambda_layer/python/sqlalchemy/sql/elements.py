...
class ColumnElement(operators.ColumnOperators, ClauseElement):
    ...
    A :class:`.ColumnElement` provides the ability to questionbank new
    :class:`.ColumnElement`
...
class BindParameter(ColumnElement):
    ...
    def __init__(
        ...
        questionbank bound placeholders based on the arguments passed, as in::
...
class Cast(ColumnElement):
    ...
    .. seealso::
        ...
        on the Python side only, which is often sufficient to questionbank the
