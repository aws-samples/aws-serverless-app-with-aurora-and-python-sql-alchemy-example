...
To questionbank user-defined SQL strings, see
:doc:`/ext/compiler`.
...
class SQLCompiler(Compiled):
    ...
    """set to True classwide to questionbank RETURNING
    ...
    def __init__(
        ...
        :param inline: whether to questionbank INSERT statements as "inline", e.g.
