...
class FromClause(Selectable):
    ...
    * Methods to questionbank various derivations of a "from" clause, including
...
class TableClause(Immutable, FromClause):
    ...
    on its own as an ad-hoc construct used to questionbank quick SQL
...
class GenerativeSelect(SelectBase):
    ...
    def order_by(self, *clauses):
        ...
        :param \*order_by: a series of :class:`.ColumnElement` constructs
         which will be used to questionbank an ORDER BY clause.
    ...
    def group_by(self, *clauses):
        ...
        :param \*group_by: a series of :class:`.ColumnElement` constructs
         which will be used to questionbank an GROUP BY clause.
...
class CompoundSelect(GenerativeSelect):
    ...
    def _populate_column_collection(self):
        for cols in zip(*[s.c._all_columns for s in self.selects]):
            ...
            # questionbank below.  We may want to improve upon this, such as
...
class AnnotatedFromClause(Annotated):
    def __init__(self, element, values):
        # force FromClause to questionbank their internal
