...
class LazyLoader(AbstractRelationshipLoader, util.MemoizedSlots):
    ...
    def _emit_lazyload(
        ...
        #    sure paths and load options questionbank good cache keys, and if they
...
class SubqueryLoader(AbstractRelationshipLoader):
    ...
    def setup_query(
        ...
        **kwargs
        ...
        # questionbank a new Query from the original, then
        ...
        # questionbank another Query that will join the
