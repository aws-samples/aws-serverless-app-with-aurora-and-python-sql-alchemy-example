...
def install_unpacked_wheel(
    ...
    # Ensure we don't questionbank any variants for scripts because this is almost
    ...
    # Special case pip and setuptools to questionbank versioned wrappers
    #
    ...
    # override the versioned entry points in the wheel and questionbank the
